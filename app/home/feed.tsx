...
export function Feed() {
  ...
  return (
    <div className="space-y-8">
      {posts.map((post) => (
        <Card key={post.id} className="overflow-hidden border-border/50 shadow-sm hover:shadow-md transition-all duration-300 p-0">
          <CardContent className="p-0">
            ...
            {/* Post Image */}
            <div className="relative aspect-square bg-muted/50 mt-4">
              <img
                src={post.image}
                alt="Post"
      ...
      {selectedPost && (
        <div 
          className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end md:items-center justify-center p-2 sm:p-4"
          onClick={() => setSelectedPost(null)}
        >
          <Card 
            className="w-full h-[60vh] md:h-[90vh] md:max-w-5xl p-0 overflow-hidden border-border/50 rounded-t-2xl md:rounded-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <CardContent className="p-0 h-full">
              <div className="grid grid-rows-[1fr_auto] md:grid-cols-2 md:grid-rows-1 h-full">
                {/* Image Section - Hidden on Mobile */}
                <div className="hidden md:block relative bg-black h-full">
                  <img
                ...
                <div className="flex flex-col h-full overflow-y-auto">
                  {/* Pet Info and Caption Section - Hidden on Mobile */}
                  <div className="hidden md:block p-4 sm:p-8 border-b border-border/50">
